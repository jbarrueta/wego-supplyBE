...
class TestDispatch(unittest.TestCase):
    def setUp(self):
        self.dispatch= Dispatch("test2service", "1", "[-97.758911, 30.231760]", "testpass", "2", 
...
class TestCoordinates(self):
    def test_getOrderCoordinates(self):
        self.assertEqual(self.dispatch.order_coords, "[-97.758911, 30.231760]")

class TestFleetId(self):
